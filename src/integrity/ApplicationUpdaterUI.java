...
public class ApplicationUpdaterUI extends JWindow {
  ...
  public ApplicationUpdaterUI() {
    ...
    try {
      tReader = new TagReader(this.getClass().getResourceAsStream("config.properties"));
      intiFiles();
...
//System.out.println("Server: " + tReader.getTagValue("structure","server"));
//System.out.println("Local: " + tReader.getTagValue("structure","local"));
    serverDir = new File(tReader.getTagValue("structure","server"));
//System.out.println("serverDir: " + serverDir.getAbsolutePath());
...
//      System.out.println("Local Copy Missing...attempting to copy the new version");
    }
    timer.sleep(1000);
